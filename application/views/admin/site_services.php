<?php echo getBredcrum(ADMIN, array('#' => 'Our Services Page')); ?>
<?php echo showMsg(); ?>
<div class="row margin-bottom-10">
    <div class="col-md-6">
        <h2 class="no-margin"><i class="entypo-window"></i> Update <strong>Our Services Page</strong></h2>
    </div>
        ...
        <form role="form"  method="post" class="form-horizontal form-groups-bordered validate" novalidate="novalidate" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="col-md-12">
                    <div class="form-group">
                        <div class="col-md-12">
                            <label for="services_heading" class="control-label"> Heading <span class="symbol required">*</span></label>
                            <input type="text" name="services_heading" value="<?= $row['services_heading'] ?>" class="form-control" required>
                        </div>
                    </div>
                </div>
            </div>
