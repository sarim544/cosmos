        ...
        <div class="row col-md-12">
            <form action=""  role="form" class="form-horizontal" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <div class="col-md-4">
                            <label class="control-label" for="mem_bg_check"> Background Check</label>
                            <select name="mem_bg_check" id="mem_bg_check" class="form-control">
                                <option value="0" <?php
                                if (isset($row->mem_bg_check) && '0' == $row->mem_bg_check) {
                                    echo 'selected';
                                }
                                ?>>No</option>
                                <option value="1" <?php
                                if (isset($row->mem_bg_check) && '1' == $row->mem_bg_check) {
                                    echo 'selected';
                                }
                                ?>>Yes</option>
                            </select>
                        ...
                        <div class="col-md-4">
                            <label class="control-label" for="mem_inspected"> Inspected</label>
                            <select name="mem_inspected" id="mem_inspected" class="form-control">
                                <option value="0" <?php
                                if (isset($row->mem_inspected) && '0' == $row->mem_inspected) {
                                    echo 'selected';
                                }
                                ?>>No</option>
                                <option value="1" <?php
                                if (isset($row->mem_inspected) && '1' == $row->mem_inspected) {
                                    echo 'selected';
                                }
                                ?>>Yes</option>
                            </select>
                    ...
                    <div class="inspctnPrv<?= (isset($row->mem_inspected) && '1' == $row->mem_inspected)?'':' hidden'?>">
                        <div class="form-group">
                            <div class="col-md-12">
                                <h3><i class="fa fa-bars"></i> Inspection Video</h3>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="field">Upload Video</label>
                                        <input type="file" name="mem_video" id="mem_video" accept="video/mp4" class="form-control file2 inline btn btn-primary" data-label="<i class='fa fa-upload'></i> Browse Inspection Video" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <?php if (!empty($row->mem_video)): ?>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <h3><i class="fa fa-bars"></i> Inspection Images</h3>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="upload_files[]" id="uplocamp_file" multiple class="form-control file2 inline btn btn-primary" accept="image/*" data-label="<i class='fa fa-upload'></i> Browse Inspection Images" />
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    if (count($row->images) > 0) :
                                        foreach ($row->images as $img) :
                                            ?>
                                            <div class="col-md-3 text-center margin-bottom-10 img-blk">
                                                <img src="<?= get_image_src($img->image,'150')?>" style="height:50px; margin-bottom: 10px;"><br>
                                    ...
                                    <ul class="qsnLst">
                                        ...
                                        <li>
                                            ...
                                            <label for="childrenno" class="control-label">
                                                <input type="radio" name="mem_children" value="No" id="childrenno"<?= $row->mem_children=='No'?' checked="true"':''?>>Has no children
                                            </label>
                            ...
                            <div class="col-md-12">
                                ...
                                <?php foreach ($days as $day_key => $day): ?>
                                    <div class="form-group col-md-12 dayLst">
                                        <label for="<?= $day?>">
                                            <input type="checkbox" name="days[<?= $day_key?>]" value="<?= $day?>" id="<?= $day?>" <?= empty($player_timings[$day_key]->available)?'':'checked=""' ?>> <?= $day?>
                                        </label>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <input type="text" name="start_time[<?= $day_key?>]" value="<?= empty($player_timings[$day_key]->available)?'':get_meridian_time($player_timings[$day_key]->start_time) ?>" <?= empty($player_timings[$day_key]->available)?'disabled':'' ?> class="form-control timepicker">
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" name="end_time[<?= $day_key?>]" value="<?= empty($player_timings[$day_key]->available)?'':get_meridian_time($player_timings[$day_key]->end_time) ?>" <?= empty($player_timings[$day_key]->available)?'disabled':'' ?> class="form-control timepicker">
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach ?>
