<?php if ($this->uri->segment(3) == 'manage'): ?>
    <?= showMsg(); ?>
    <?= getBredcrum(ADMIN, array('#' => 'Add/Update Pet Owner')); ?>
    <div class="row margin-bottom-10">
        <div class="col-md-6">
            <h2 class="no-margin"><i class="entypo-users"></i> Add/Update <strong>Pet Owner</strong></h2>
        </div>
    ...
    <div>
        ...
        <?php else: ?>
            <?= showMsg(); ?>
            <?= getBredcrum(ADMIN, array('#' => 'Manage Pet Owners')); ?>
            <div class="row margin-bottom-10">
                <div class="col-md-6">
                    <h2 class="no-margin"><i class="entypo-users"></i> Manage <strong>Pet Owners</strong></h2>
                </div>
                <div class="col-md-6 text-right">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-primary" role="menu">
                                            <?php if ($row->mem_status == '0'): ?>
                                                <li><a href="<?= site_url(ADMIN); ?>/owners/active/<?= $row->mem_id; ?>">Active</a></li>
                                                <?php else: ?>
                                                    <li><a href="<?= site_url(ADMIN); ?>/owners/inactive/<?= $row->mem_id; ?>">Inactive</a></li>
                                                <?php endif; ?>

                                                <li><a href="<?= site_url(ADMIN); ?>/owners/manage/<?= $row->mem_id; ?>">Edit</a></li>
                                                <?php if(access(10)):?>
                                                    <li><a href="<?= site_url(ADMIN); ?>/owners/delete/<?= $row->mem_id; ?>" onclick="return confirm('Are you sure?');">Delete</a></li>
                                                <?php endif?>
                                        <li class="divider"></li>
                                        <!-- <li><a href="<?= site_url(ADMIN.'/owners/comics/'.$row->mem_id); ?>" >Comics</a></li>
                                        <li><a href="<?= site_url(ADMIN.'/owners/novels/'.$row->mem_id); ?>" >Novels</a></li>
                                        <li><a href="<?= site_url(ADMIN.'/owners/transactions/'.$row->mem_id); ?>" >Transactions</a></li>
                                        <li><a href="<?= site_url(ADMIN.'/owners/withdraws/'.$row->mem_id); ?>" >Withdraws</a></li> -->
                                        <li><a href="<?= site_url(ADMIN.'/owners/payment-methods/'.$row->mem_id); ?>" >Payment Methods</a></li>
                                        <!-- <li><a href="<?= site_url(ADMIN.'/owners/chats/'.$row->mem_id); ?>" >Chats</a></li> -->
                                    </ul>
                                </div>  
                            </td>
                        </tr>
